...
namespace LostSpells.UI
{
    ...
    public class StorePanelController
    {
        ...
        public StorePanelController(VisualElement root, VisualElement storePanel, MenuManager menuManager)
        {
            this.root = root;
        ...
        private void FindUIElements()
        {
            ...
            // 헤더 화폐 표시
            headerDiamondsLabel = storePanel.Q<Label>("HeaderDiamonds");
            headerReviveStonesLabel = storePanel.Q<Label>("HeaderReviveStones");

            // 카테고리 버튼
            diamondButton = storePanel.Q<Button>("DiamondButton");
            reviveStoneButton = storePanel.Q<Button>("ReviveStoneButton");

            // 상품 패널
            diamondPanel = storePanel.Q<VisualElement>("DiamondPanel");
            reviveStonePanel = storePanel.Q<VisualElement>("ReviveStonePanel");

            // 상품 그리드 찾기
            diamondProductGrid = storePanel.Q<VisualElement>("DiamondProductGrid");
            reviveStoneProductGrid = storePanel.Q<VisualElement>("ReviveStoneProductGrid");

            // 다이아 부족 팝업
            insufficientDiamondPopup = storePanel.Q<VisualElement>("InsufficientDiamondPopup");
            confirmInsufficientDiamondButton = storePanel.Q<Button>("ConfirmInsufficientDiamondButton");
        }
        ...
        public void UpdateLocalization(LocalizationManager loc)
        {
            ...
            // Title/Header 업데이트
            var storeTitle = storePanel.Q<Label>("StoreTitle");
            if (storeTitle != null)
                storeTitle.text = loc.GetText("store_title");
        ...
        private void ShowDiamondPanel()
        {
            ...
            // 버튼 선택 상태 업데이트
            diamondButton?.AddToClassList("selected");
            reviveStoneButton?.RemoveFromClassList("selected");
        }
        ...
        private void ShowReviveStonePanel()
        {
            ...
            // 버튼 선택 상태 업데이트
            diamondButton?.RemoveFromClassList("selected");
            reviveStoneButton?.AddToClassList("selected");
        }
